...
export default function Home() {
  ...
  const dynamicDescription = sanitize(
    "All your flooring projects in one place.",
  );
    ...
    <main className="flex min-h-screen flex-col items-center justify-center bg-page-bg text-foreground">
      ...
      <div className="rounded-lg bg-page-surface p-8 shadow-lg flex flex-col items-center">
        ...
        <div className="flex flex-col gap-4 w-full max-w-xs mb-6">
          <a
            href="/login"
            className="w-full inline-block rounded bg-accent px-4 py-2 text-background font-semibold text-center hover:bg-accent/80 transition"
          >
            Owner Login
          </a>
          <a
            href="/onboarding"
            className="w-full inline-block rounded bg-primary px-4 py-2 text-background font-semibold text-center hover:bg-primary/80 transition"
          >
            Start Onboarding
          </a>
        </div>
