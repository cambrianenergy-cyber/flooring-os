...
export default function AIUsagePage() {
  ...
  const { data: usageData, loading, error } = useAIUsageData(workspaceId, monthKey);
  // TODO: Calculate nearCap from usageData
  const nearCap = cap && usageData ? usageData.reduce((sum, u) => sum + (u.tokens || 0), 0) > cap * 0.8 : false;
