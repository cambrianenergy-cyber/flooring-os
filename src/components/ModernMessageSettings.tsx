...
export default function ModernMessageSettings({
  drafts,
  onClose,
}: ModernMessageSettingsProps) {
  ...
  return (
    <div className="max-w-md mx-auto bg-gray-50 p-6 rounded shadow">
      ...
      <div className="mb-4">
        ...
        <ul className="max-h-24 overflow-y-auto text-xs bg-background text-slate-900 border rounded p-2">
