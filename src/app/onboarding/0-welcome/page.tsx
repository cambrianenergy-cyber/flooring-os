        ...
        <div className="max-w-lg w-full bg-background text-slate-900 rounded-xl shadow-lg p-8 mt-10">
          <div className="flex flex-col items-center mb-6">
            ...
            <h1 className="text-3xl font-bold mb-1 text-gray-900">
              Welcome to Square Flooring OS
            </h1>
            <p className="text-gray-700 mb-2">
              We’re going to set up your company OS
            </p>
            <OnboardingProgress currentStep={1} />
            <span className="text-xs text-muted">
              Step 1 of 9 &bull; ~6 minutes to finish setup
            </span>
          </div>
          <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-2">
                {GOALS.map((goal) => (
                  <button
                    key={goal}
                    type="button"
                    className={`px-3 py-1 rounded border ${goals.includes(goal) ? "bg-blue-700 text-background" : "bg-gray-100 text-muted"}`}
            ...
            <div className="flex items-center justify-between mt-6">
              <button
                className="bg-blue-700 text-background px-6 py-2 rounded font-semibold shadow hover:bg-blue-800 transition disabled:opacity-50"
                onClick={handleStart}
                disabled={
                  loading ||
                  !accountType ||
