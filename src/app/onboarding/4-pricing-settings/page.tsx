    ...
    <OnboardingLayout step={4}>
      <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-blue-50 to-white">
        <div className="max-w-lg w-full bg-white rounded-xl shadow-lg p-8 mt-10">
          <h1 className="text-3xl font-bold mb-4 text-center">Pricing Settings</h1>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-sm font-medium mb-1">Pricing Preset</label>
              <select
          ...
          <span className="text-xs text-muted block text-center mt-2">Step 5 of 9</span>
        </div>
      </div>
    </OnboardingLayout>
  );
