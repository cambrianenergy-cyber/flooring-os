...
export function EmptyStateJobs() {
  return (
    <div className="flex flex-col items-center justify-center h-full py-16 text-center">
      ...
      <div className="mb-4 text-[#7985a8]">
        Jobs are created from approved estimates. Convert an estimate to a job
...
export function EmptyStateInvoices() {
  return (
    <div className="flex flex-col items-center justify-center h-full py-16 text-center">
      ...
      <div className="mb-4 text-[#7985a8]">
        Invoices are sent to clients after work is completed. Create an invoice
...
export function EmptyStateReviews() {
  return (
    <div className="flex flex-col items-center justify-center h-full py-16 text-center">
      ...
      <div className="mb-4 text-[#7985a8]">
        Reviews help you close the loop and improve your process. Request a
        review after completing a job.
      </div>
      <Link
        href="/jobs"
        className="bg-indigo-600 text-background px-6 py-2 rounded font-semibold hover:bg-indigo-700 transition"
