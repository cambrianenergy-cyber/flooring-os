    ...
    return (
      <div className="p-4">
        ...
        <p className="text-sm text-gray-600">
          Set localStorage.workspaceId to view workspace data.
        </p>
      </div>
    );
  }
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Card
            ...
            items={agentRuns}
            fields={["agentId", "status", "error", "updatedAt"]}
          />
          <Card
            title="Open Workflow Failures"
            items={workflowFailures}
            fields={["workflowId", "runId", "message", "occurredAt"]}
          />
          <Card
            title="Recent Workflow Triggers"
            items={workflowTriggers}
            fields={["workflowId", "source", "eventKey", "firedAt"]}
          />
          <Card
            title="Recent Audit Events"
            items={auditEvents}
            fields={["action", "entityType", "entityId", "createdAt"]}
          />
        </div>
      </div>
    </AuthGuard>
...
function Card({
  ...
  return (
    <div className="border rounded p-3 bg-background text-slate-900 shadow-sm">
